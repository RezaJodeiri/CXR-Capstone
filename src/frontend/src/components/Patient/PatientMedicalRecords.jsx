...
import { FiPlus, FiArrowUp, FiUpload, FiZoomIn, FiZoomOut, FiRotateCw, FiArrowLeft } from 'react-icons/fi';
            ...
            <div className="mt-12 grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="lg:col-span-5 bg-white rounded-lg border border-gray-200">
                <div className="p-6 space-y-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="p-4 bg-red-50 border border-red-100 rounded-lg">
                        <div>
                          <h4 className="font-medium text-red-900">Pneumonia</h4>
                      ...
                      <div className="space-y-3">
                        <h4 className="font-medium text-gray-700">Region Analysis</h4>
                        <div className="grid grid-cols-2 gap-2">
                          {['Upper Right', 'Upper Left', 'Lower Right', 'Lower Left'].map((region) => (
                            <button
                              key={region}
                              ...
                              onClick={() => setSelectedRegion(region.toLowerCase().replace(' ', '-'))}
                            >
                              {region}
                            </button>
                          ))}
                        ...
                        {selectedRegion && (
                          <div className="mt-4 space-y-3">
                            <h5 className="text-sm font-medium text-gray-600">
                              Top Findings for {selectedRegion.split('-').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ')}
                            </h5>
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <div className="w-full border border-gray-200 rounded-lg p-4 min-h-[120px] text-sm text-gray-700 whitespace-pre-line">
                        {findings || "1. Right lower lobe consolidation with air bronchograms\n2. No pleural effusion\n3. Heart size within normal limits\n4. No pneumothorax"}
                      </div>
                    )}
                  </div>
                  ...
                  {/* Impression */}
                  <div>
                    <h3 className="text-lg font-medium text-gray-900 mb-2">Impression</h3>
                    {isEditing ? (
                      <textarea
                      ...
                      <div className="w-full border border-gray-200 rounded-lg p-4 min-h-[100px] text-sm text-gray-700 whitespace-pre-line">
                        {impression || "Right lower lobe pneumonia. Follow-up radiograph recommended after completion of treatment to ensure resolution."}
                      </div>
                    )}
                  </div>
                </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200">
        ...
        <div className="flex items-center justify-between px-6 py-3 border-t">
          ...
          <div className="flex gap-2">
            <button className="px-3 py-1 text-sm border rounded text-gray-500 hover:bg-gray-50 transition-all duration-200 hover:shadow-sm hover:-translate-y-0.5 active:translate-y-0 active:shadow-none disabled:opacity-50 disabled:hover:bg-white disabled:hover:shadow-none disabled:hover:translate-y-0" disabled>
              Previous
            </button>
