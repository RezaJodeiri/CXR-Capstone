...
function Sidebar({ isCollapsed, toggleCollapse }) {
  ...
  return (
    <div
      className={`${isCollapsed ? "w-20" : "w-64"} bg-white transition-all duration-300 relative h-screen border-r border-gray-200`}
    >
      <button
      ...
      <div className="p-6">
        <h1
          className={`text-2xl font-semibold text-primary ${isCollapsed ? "hidden" : ""}`}
        >
          Neuralanalyzer
        </h1>
      </div>
