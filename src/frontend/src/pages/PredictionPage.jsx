...
import { FaExternalLinkAlt, FaTimes, FaChevronLeft } from "react-icons/fa";
      ...
      <div className="w-full bg-white border-b border-gray-200 px-6 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-lg font-medium">Disease Prediction Tool</h2>
          </div>
          <button 
            onClick={() => navigate(-1)} 
            className="flex items-center gap-2 text-[#3C7187] hover:underline"
          >
