...
\item [\refstepcounter{mnum} \mthemnum \label{mDocProfileView}:] Doctor Profile View 
...
\item [\refstepcounter{mnum} \mthemnum \label{mRecordView}:] Medical Record View
...
Modules: mDiseaseProgress, mDocProfileView, mPatientList, mPatientOverview, mProgressView \\
...
Modules: mDocProfileView, mPatientList, mPatientOverview, mProgressView, mRecordsList, mRecordView \\
...
Modules: mDocProfileView, mPatientList, mPatientOverview, mProgressView, mRecordView, mRecordsList, mReportView \\
...
\subsubsection{Doctor Profile View Module (\mref{mDocProfileView})}
\begin{description}
\item[Secrets:] Data privacy rules and handling of doctor-specific information such as personal details, qualifications, and history.
\item[Services:] Displays detailed information about the doctor's profile, including their qualifications, specialization, experience, and associated medical records. Provides functionality to update profile information based on user role.
...
FR8: Provide alerts for significant condition changes & \mref{mDiseaseProgress}, \mref{mDocProfileView}, \mref{mPatientList}, \mref{mPatientOverview}, \mref{mProgressView}\\
...
\midrule
LF1: Consistent user interface & \mref{mDocProfileView},\mref{mPatientList},\mref{mPatientOverview},\mref{mProgressView},\mref{mRecordsList},\mref{mRecordView} \\
LF2: Ergonomic color schemes and fonts & \mref{mDocProfileView},\mref{mPatientList},\mref{mPatientOverview},\mref{mProgressView},\mref{mRecordsList},\mref{mRecordView} \\
UH1: Usability for common tasks & \mref{mDocProfileView},\mref{mPatientList},\mref{mPatientOverview},\mref{mProgressView},\mref{mRecordsList},\mref{mRecordView} \\
...
CR1: Support English and French languages & \mref{mDocProfileView},\mref{mPatientList},\mref{mPatientOverview},\mref{mProgressView},\mref{mRecordsList},\mref{mRecordView},\mref{mReportView}\\
...
\acref{acUI} & \mref{mDocProfileView}, \mref{mPatientList}, \mref{mPatientOverview}, \mref{mProgressView}, \mref{mRecordsList}, \mref{mRecordView}, \mref{mReportView}\\
