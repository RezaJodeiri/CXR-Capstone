...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{DETR.png}
    \caption{DETR Model}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Disease_Classification.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{detr_performance.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Region_7.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{detr_roc.png}
    \caption{Our Model}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.35\textwidth]{all_regions.png}
