...
\textbf{NFR-LF1} \textbf{Type} Interactive Dynamic Manual\\
        ...
        \\
\textbf{NFR-LF2} \textbf{Type} Interactive Dynamic Manual \\
...
\noindent \textbf{NFR-UH1} \textbf{Type} Performance Dynamic Automated \\
...
\\
\textbf{NFR-UH2} \textbf{Type} Interactive Dynamic Automated \\
...
\noindent \textbf{NFR-PR1} \textbf{Type} Structural Dynamic Automated \\
        ...
        \indent \textbf{Output}: Boolean, whether the chest X-ray image is analyzed correctly.\\
        \indent \textbf{How test will be performed}: The test script will upload a X-ray image through the interface. It will monitor the system to ensure it processes and analyzes the image. The moment the results or report are displayed or the system indicates completion, it checks the timing (<30 seconds). The process is repeated multiple times (at least 5 trials) to account for variations in processing time. If all trials pass (duration < 30 seconds), the system returns True, else return False. \\
\\
\textbf{NFR-PR2} \textbf{Type} Performance Dynamic Automated \\
...
\\
\textbf{NFR-PR3} \textbf{Type} Performance Dynamic Automated\\
        ...
        \\
\textbf{NFR-OE1} \textbf{Type} Structural Dynamic Manual\\
        ...
        \indent \textbf{Input / Condition}: AI-processed resuslts including annotations or diagnostic report as an image (in DICOM format). Metadata with patient ID (string) and instance number (string).\\
        ...
        \\
\textbf{NFR-OE2} \textbf{Type} Performance Dynamic Automated\\
...
\noindent \textbf{NFR-SR1} \textbf{Type} Security Dynamic Automated\\
         ...
         \\
\textbf{NFR-SR2} \textbf{Type} Structural Dynamic Automated\\
        ...
        \\
\textbf{NFR-MS1} \textbf{Type} Structural Static Manual\\
...
\noindent \textbf{NFR-MS2} \textbf{Type} Integration Dynamic Automated\\
...
\noindent \textbf{NFR-LR1} \textbf{Type} Non-Functional Dynamic Manual\\
...
\noindent \textbf{NFR-LR2} \textbf{Type} Static Manual\\
...
\\
\textbf{NFR-HS1} \textbf{Type} Interactive Dynamic Manual\\
...
\noindent \textbf{NFR-HS2} \textbf{Type} Interactive Dynamic Manual\\
