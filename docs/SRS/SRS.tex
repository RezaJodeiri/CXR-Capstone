...
\begin{tabularx}{\textwidth}{p{3cm}p{2cm}X}
  ...
  \midrule
  2024-11-01 & 1.0 & Added reference material, functional and non-functional requirements, and outlined the purpose of the project.\\
  2024-11-07 & 1.1 & Included details about stakeholders, system constraints, and an analysis of the potential impact of the project on various sectors.\\
  2024-11-11 & 1.2 & Developed formal mathematical specifications, designed a Finite State Machine (FSM) for the system, and provided a reflection on the project's challenges and future directions.\\
  \bottomrule
  \end{tabularx}
...
This refers to Dr. Moradi and his research team. They are responsible for the design, development and future changes of the AI system.
\begin{enumerate}
\textbf{Role:} Main decision makers of the scope, features, system design of the AI system. They will provide necessary feedback / area of improvements and approval of the AI system. 
\end{enumerate}
\subsubsection{The Customers:}
This refers to healthcare providers, patients and medical facilities.\\
\\
Healthcare Providers includes physicians, radiologists, doctors etc. They are the primary uses of the AI system, as the software will help them in interpreting chest X-rays more efficiently by detecting abnormalities and analyzing potential diseases. The use of this software as part of the diagnostic process will help improve efficiency and accuracy.
\begin{enumerate}
\textbf{Role:} They will use the AI system to aid in clinical diagnosis and decision-making. They will upload the X-Ray and interpret the result produced by the AI system, making changes / adjustments if necessary. They will read chest X-rays faster and more accurately with the aid of AI, reducing workload and helping to make decisions on priorities.They can also help point out if the AI system makes any mistakes which helps it improve accuracy / cover rare diseases overtime.
\end{enumerate}
\\
\\
Patients include people who has certain lung / cardiac diseases or people who thinks that they might have one. They benefit from faster, more accurate diagnoses with a improved healthcare accessibility. They also can get early detection of life-threatening diseases.\\
\begin{enumerate}
 \textbf{Role:} Upload X-ray images and receive results from the AI system. Patients provide the chest X-rays that the AI system analyzes, which are critical for the AI to perform its diagnostic function. Patient data (X-rays) might be used to improve AI system, so they are required to give consent for their X-ray images to be used in AI development.
\end{enumerate}
\\
Medical facilities include hospitals and clinics. They can integrate the software into their hospital systems, which can help them to improve efficiency, reduce diagnostic errors, manage costs.\\
\begin{enumerate}
\textbf{Role:} They will integrate the AI system into their existing infrastructure (radiology departments, diagnostic tools etc). They are also responsible for validating the AI system's performance in their environment. They will monitor how well the AI is in diagnosing chest abnormalities and ensuring that the results align with clinical expectations. 
\end{enumerate}
\\
\subsubsection{Other Stakeholders:} 
This includes technical support team and technicians who works for hospital. they are responsible for ensuring seamless connectivity with existing systems, maintaining workflow, and ensuring data security and privacy. \\
\begin{enumerate}
\textbf{Role:} They help configure the AI system based on the  needs of the medical facility. They ensures compatibility of the AI system with the hospital’s workflow and making necessary adjustments to optimize performance.
\end{enumerate}
...
Government Regulations: The system must comply with healthcare regulations and approvals from bodies such as FDA and follow PHIPA and the certifications required before releasing the system into real-world use. This is an important constraint because non-compliance could lead to legal consequences, fines, or the inability to operate in certain regions.
\\
Data Usage Consent: The system is constrained by patients’ consent to use their data as in Canada there is the PIPEDA. In some jurisdictions, even anonymized data may require explicit patient approval, limiting the available training datasets. Even when data is anonymized, these laws may still apply because of the potential for re-identification through advanced techniques. Failing to abide by this can result in severe penalties, including fines, lawsuits, or even the suspension of the service.
\\
Cultural Sensitivity: Different regions and cultures may have varying comfort levels with AI making health decisions, restricting where or how the system can be rolled out. Some countries may prefer human oversight in every case. This is important as some regions will not welcome our technology so it's important to note who our target for this application should be. 
\\
Budget Limitations in Hospitals: The application may face constraints from healthcare organizations with limited budgets, meaning it must be affordable and sustainable. This may restrict access to cutting-edge hardware or limit the speed of the application. Without the resources to invest into our application our application will not be able to run in that hospital so it's important to make our application very light-weight and ensure that we can get some resources from the hospital it's being hosted/used in.
\\
Legal Liability: In case of misdiagnosis, the liability for the application’s results may be constrained by local laws, requiring legal protections or disclaimers. It is important to have protection and get consent from the patient as not doing so may result in fines or legal action taken against our company. 
\\
Compatibility with Older Equipment: The system might need to work with older X-ray machines, limited computational resources, or restricted internet bandwidth in some hospitals. These are hard limits based on existing infrastructure that cannot be easily changed. This is essential as without the key input of the X-ray our system will not function. 
\pagebreak
