...
\begin{tabularx}{\textwidth}{p{3cm}p{2cm}X}
  ...
  \midrule
  2024-10-01 & 1.0 & Added reference material, functional and non-functiona requirements, and outlined the purpose of the project.\\
...
\hline
    & \textbf{FR1} & \textbf{FR2} & \textbf{PR4} & \textbf{FR4} & \textbf{FR5} & \textbf{FR6} & \textbf{FR7} & \textbf{FR8} & \textbf{FR9} & \textbf{FR10} & \textbf{FR11} & \textbf{FR12} & \textbf{FR13} & \textbf{FR14} & \textbf{FR15} & \textbf{FR16} \\
\hline
\textbf{FR1} & X & X & & & & & X & & & & & & & & & \\
\hline
\textbf{FR2} & & X & & & & & & & & & & & & & & X \\
\hline
\textbf{PR4} & X & & X & X & X & X & & & & & & & & & & X \\
\hline
\textbf{FR4} & & & X & X & X & & & X & & & & & & & & \\
\hline
\textbf{FR5} & & & & X & X & X & & & & & & & & & X & \\
